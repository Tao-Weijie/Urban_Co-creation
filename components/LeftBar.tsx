...
export default function LeftBar({
  ...
  return (
    <div className="absolute top-6 left-6 z-10 w-80 max-w-sm rounded-2xl border border-black/10 bg-white/70 dark:border-white/10 dark:bg-black/60 p-5 shadow-2xl backdrop-blur-md transition-all duration-300 hover:border-black/20 dark:hover:border-white/20 text-zinc-800 dark:text-zinc-200">
